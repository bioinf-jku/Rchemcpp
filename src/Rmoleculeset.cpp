...
//Rcpp::List::create( Rcpp::_["aFileName"] Rcpp::_["genericAtomTypeFlag"] = 0, Rcpp::_["beginMolecule"] = -1, Rcpp::_["endMolecule"] = -1  ),		
	...
	.method( "deleteAll", &Rmoleculeset::deleteAll, "delete all molecules in a moleculeset");
	//.method( "deleteIdx", &Rmoleculeset::deleteIdx, "delete certain molecules given by index in a moleculeset");
